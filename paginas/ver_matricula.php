...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
    ...
    $conn = new mysqli("localhost", "santand1_santand1", "AndresBrown11@", "santand1_itgem");
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>Ruta de documentos: <a href="<?php echo $estudiante['ruta_documentos']; ?>" target="_blank"><?php echo $estudiante['ruta_documentos']; ?></a></p>
                        </div>
