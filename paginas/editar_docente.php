...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE docentes SET nombre = ?, apellido = ?, tipo_documento = ?, documento_identidad = ?, direccion = ?, titulo = ?, email = ?, fecha_nacimiento = ? WHERE id = ?";
    ...
    if (!$conexion->connect_error) {
        ...
        if ($stmt) {
            ...
            $stmt->bind_param("ssssssssi", $nombre, $apellido, $tipo_documento, $documento_identidad, $direccion, $titulo, $email, $fecha_nacimiento, $id);
