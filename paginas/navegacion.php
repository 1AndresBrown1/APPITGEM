...
<span class="ms-3 badge text-bg-danger"><?php if (isset($message)) : ?>
                                <p class="designattion mb-0" style="color: white; font-size: 14px; padding: 2px;"><?php echo $message; // mensaje de administrador  
                                                    ?></p>
                            <?php endif; ?></span> <span class="mb-3 ms-3"><span class="fw-bold"><?php
...
<div class="espacecustom mt-4 border">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="./academico.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    Academico
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="./crear_a.php">Gestion de Años</a></li>
                                    <li><a class="dropdown-item" href="./grupos.php">Grupos</a></li>
                                    <li><a class="dropdown-item" href="./modulos.php">Modulos</a></li>
                                    <li>
                                        <hr class="dropdown-divider">
                                    </li>
                                    <li><a class="dropdown-item" href="./academico.php">Academico</a></li>
    ...
    <script type="module" src="./funciones/show.js"></script>
